...
function Navbar() {
    return (
        <header>
            <nav className="fixed top-0 left-0 w-full z-50 bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 ">
                        ...
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <NavLink
                                    ...
                                    className={({ isActive }) =>
                                        isActive
                                            ? "block py-2 pr-4 pl-3 text-white font-semibold lg:p-0"
