                ...
                <div className="bg-gray-100 p-5 flex rounded-2xl shadow-lg max-w-3xl">
                    <div className="md:w-1/2 px-5 pr-10">
                        ...
                        <form className="mt-6" action="#" method="POST">
                            ...
                            <button onClick={PressedLoginButton} type="submit" className="w-full block bg-blue-500 hover:bg-blue-400 focus:bg-blue-400 text-white font-semibold rounded-lg px-4 py-3 mt-6">Log In</button>
